...
#     pkg_urdf_path = get_package_share_directory('rosbot_description')
#     pkg_gazebo_path = get_package_share_directory('rosbot_gazebo')
...
#         'model', default_value='rosbot.urdf.xacro',
